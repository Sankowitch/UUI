...
public class Solution {
	...
	public static void main(String ... args)   {
		...
		String putanja = "x";        //putanja do datoteke gdje su upute za stanja
		String algoritam ="x";       //ime algoritma koji se koristi
		String h ="x";               //putanja do heursitike koja se koristi istra_heuristic.txt
